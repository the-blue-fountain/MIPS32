...
#
# Script generated by Vivado on Wed Nov 06 17:44:32 +0530 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : instr_memory.sh
...
#
# Usage        : instr_memory.sh
#                instr_memory.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                instr_memory.sh [-reset_run]
#                instr_memory.sh [-reset_log]
#                instr_memory.sh [-help]
#
...
#                script (type 'instr_memory.sh -help' for more information).
#
...
# script info
echo -e "instr_memory.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./instr_memory.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.instr_memory xil_defaultlib.glbl -o instr_memory_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./instr_memory_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key instr_memory_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc instr_memory_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./instr_memory.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: instr_memory.sh [-help]\n\
Usage: instr_memory.sh [-step]\n\
Usage: instr_memory.sh [-lib_map_path]\n\
Usage: instr_memory.sh [-reset_run]\n\
Usage: instr_memory.sh [-reset_log]\n\
Usage: instr_memory.sh [-keep_index]\n\
Usage: instr_memory.sh [-noclean_files]\n\n\
